...
function BudgetCategoryRow({
    ...
    isEditing: boolean;
    budgetInputVal: string;
    setBudgetInputVal: Dispatch<SetStateAction<string>>;
    setEditingBudgetCat: Dispatch<SetStateAction<EntityId | null>>;
    apiFetch: ApiFetcher;
    fetchBudgets: () => void;
                    ...
                    {isEditing ? (
                        <>
                            <input
                                ...
                                onChange={(event) =>
                                    setBudgetInputVal(event.target.value)
                                }
                                autoFocus
                            />
                            <button
