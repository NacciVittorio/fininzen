...
export type CsvImportTypeOption = { key: CsvImportType; label: string };
...
export function CsvImportTypeSelector({
    ...
    T: Translator;
    importTypeOptions: readonly CsvImportTypeOption[];
    csvImportType: CsvImportType;
    setCsvImportType: Dispatch<SetStateAction<CsvImportType>>;
