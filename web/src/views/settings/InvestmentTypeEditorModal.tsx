...
import type { InvestmentTypeForm } from "../../context/useAppProviderState";
...
export function InvestmentTypeEditorModal({
    ...
    T: Translator;
    showInvTypeModal: boolean;
    editingInvTypeId: EntityId | null;
    invTypeContext: "investments" | "account_types";
    closeInvTypeModal: () => void;
    invTypeForm: InvestmentTypeForm;
    setInvTypeForm: Dispatch<SetStateAction<InvestmentTypeForm>>;
    invTypeError: string;
    setInvTypeError: Dispatch<SetStateAction<string>>;
    addInvestmentType: () => void;
}) {
    return (
        <>
            {showInvTypeModal && (
                            ...
                            <>
                                ...
                                >
                                    <input
                                        type="checkbox"
                                        checked={
                                            !!invTypeForm.supports_contribution_source
                                        }
                                        onChange={(e) =>
                                            setInvTypeForm((p) => ({
                                                ...p,
