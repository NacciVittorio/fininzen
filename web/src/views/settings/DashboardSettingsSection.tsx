...
import type { DashboardSection } from "../../context/appContextHelpers";

type DashReorder = ReturnType<typeof useDragReorder>;
...
export function DashboardSettingsSection() {
    ...
    const dashLabels: Record<string, string> = {
    ...
    const isDashConfigFeatureEnabled = (id: string) => {
...
function DashboardCardSettingRow({
    ...
    index: number;
    visibleDashCards: DashboardSection[];
    dashLabels: Record<string, string>;
    dashReorder: DashReorder;
    moveDashCard: (id: string, dir: -1 | 1) => void;
    toggleDashCard: (id: string) => void;
}) {
        ...
        >
            ...
            <div className="row" style={{ gap: 4, alignItems: "center" }}>
                ...
                <DashboardMoveButton
                    ...
                    onClick={() =>
                        index < visibleDashCards.length - 1 &&
                        moveDashCard(card.id, 1)
                    }
                >
                    ↓
                </DashboardMoveButton>
