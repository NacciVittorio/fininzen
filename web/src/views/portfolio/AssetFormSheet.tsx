...
import type { AccountOption } from "./addTransaction/addTransactionTypes";
...
export default function AssetFormSheet({
    ...
    selectedInvType: InvestmentType | null;
    investmentTypes: readonly InvestmentType[];
    assetFormSupportsContributionSource: boolean;
    ...
    handlePriceSourceChange: (value: string) => void;
            ...
            {showAssetModal && (
                ...
                >
                    ...
                    {selectedInvType && !selectedInvType.is_bank_account && (
                        <div>
                            <FieldLabel
                                text={T("label_contribution_source_mode")}
                            />
                            <select
                                className="inp"
                                value={
                                ...
                                onChange={(event) =>
                                    setAssetForm((previous) => ({
                                        ...previous,
                                        contribution_source_mode: event.target
                                            .value as AssetForm["contribution_source_mode"],
                                    }))
                                }
                            >
                    ...
                    {selectedInvType && !selectedInvType.is_bank_account && (
                        <div>
                            <FieldLabel
                                text={T("label_asset_tax_rate_override")}
                            />
                            <input
                                type="text"
                                inputMode="decimal"
