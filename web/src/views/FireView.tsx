    ...
    return (
        <>
            <div>
                ...
                {/* Generic 2-col dense grid (shared with portfolio); inert
                    below 1200px, where the cells are transparent divs. */}
                        ...
                        <div className="pf-cell--a">
                            ...
                            >
                                ...
                                <div className="num" style={{ marginTop: 6 }}>
                                    p50:{" "}
                                    {probability_band?.p50?.years_to_fire ??
                                        "∞"}{" "}
                                    yr | p80:{" "}
                                    {probability_band?.p80?.years_to_fire ??
                                        "∞"}{" "}
                                    yr
                                </div>
                            </div>
                        ...
                        <div className="card" style={{ marginBottom: 12 }}>
                            ...
                            >
                                <div>
                                    ...
                                    >
                                        {formatEur(
                                            parseFloat(coast_fire.coast_number),
                                        )}
                                    </div>
                                </div>
                                <div>
