          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                borderRadius: "var(--r-pill)",
                border: 0,
                background: viewMode === m.key ? "var(--card)" : "transparent",
                color: viewMode === m.key ? "var(--fg)" : "var(--fg-soft)",
                fontFamily: "inherit",
                fontSize: 12,
                fontWeight: 600,
                cursor: "pointer",
                boxShadow:
                  viewMode === m.key ? "0 1px 2px rgba(0,0,0,0.08)" : "none",
              }}
            >
              {m.label}
            </button>
