    ...
    componentDidCatch(error: Error, info: ErrorInfo) {
        ...
        const sentry =
            typeof window !== "undefined"
                ? (window as unknown as SentryWindow).Sentry
                : undefined;
            ...
            >
                <div
                    style={{
                        ...
                        boxShadow:
                            "var(--shadow-soft, 0 8px 24px rgba(0,0,0,0.3))",
                        padding: "var(--sp-3, 24px)",
                    }}
                >
                    ...
                    >
                        L'app ha riscontrato un errore imprevisto. Ricarica la
                        pagina per riprovare; i tuoi dati sono al sicuro.
                    </p>
                    <button
                        type="button"
                        ...
                        style={{
                            ...
                            fontWeight: 600,
                            background:
                                "var(--btn-primary-bg, var(--accent, #3b82f6))",
