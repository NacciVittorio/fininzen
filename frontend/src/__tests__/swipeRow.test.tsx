...
import type { SwipeAction } from "../components/ui/SwipeRow";
...
const baseActions = (onPress: () => void = () => {}): SwipeAction[] => [
    {
        key: "delete",
        label: "Delete",
...
const leftActions = (onPress: () => void = () => {}): SwipeAction[] => [
    {
        key: "edit",
        label: "Edit",
...
describe("SwipeRow", () => {
    ...
    it("does not swipe when disabled", () => {
        ...
        expect(
            c.querySelector("[data-testid='swipe-action-delete']"),
        ).toBeNull();
    });
});
