...
import type { AssetActionTarget } from "../../components/AssetCard";
...
export default function InvestmentAssetGroups({
    ...
    archivedInvExpanded: boolean;
    setArchivedInvExpanded: Dispatch<SetStateAction<boolean>>;
    handleArchiveInvestment: (asset: AssetActionTarget) => void;
    handleUnarchiveInvestment: (id: EntityId) => void;
    deleteAsset: (id: EntityId) => void;
    openAssetEdit: (asset: AssetActionTarget) => void;
    openAdjustBalance: (asset: AssetActionTarget) => void;
    openRealizeAsset: (asset: AssetActionTarget) => void;
    openAssetAdd: () => void;
    T: Translator;
