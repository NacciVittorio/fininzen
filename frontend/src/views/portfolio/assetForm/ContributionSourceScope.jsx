    ...
    <div>
      ...
      >
        ...
        >
          <input
            type="checkbox"
            checked={(assetForm.contribution_source_ids || []).length === 0}
            onChange={(event) => {
        ...
        {activeContributionSources.map((source) => {
          const selected = (assetForm.contribution_source_ids || []).includes(
            String(source.id),
          );
          return (
            <label
            ...
            >
              <input
                ...
                onChange={(event) =>
                  setAssetForm((previous) => {
                    const current = previous.contribution_source_ids || [];
