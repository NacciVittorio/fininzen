    ...
    <>
      ...
      <div style={{ position: "relative" }}>
        ...
        <input
          ...
          onFocus={() => descSuggestions.length > 0 && setShowSuggestions(true)}
          autoComplete="off"
        />
          ...
          >
            {descSuggestions.map((text) => (
              <button
                ...
                onMouseEnter={(event) =>
                  (event.currentTarget.style.background = "var(--card-inset)")
                }
                onMouseLeave={(event) =>
        ...
        <div style={selectLikeCategoryShellStyle}>
          ...
          >
            ...
            {assets
              .filter(
                (asset) =>
                  asset.tracking_type === "MANUAL" && !asset.is_archived,
              )
              .map((asset) => (
          ...
          <span aria-hidden="true" style={selectLikeCategoryChevronStyle}>
            ▼
          </span>
        </div>
      </div>
