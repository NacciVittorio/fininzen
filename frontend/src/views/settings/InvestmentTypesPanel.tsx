...
type InvTypeActions = {
    ...
    openDeleteInvTypeFlow: (invType: InvestmentType) => void;
    openNewInvType: (context: InvTypeContext) => void;
};

type ContributionSourceActions = {
...
function InvestmentTypeList({
    ...
    handleEditInvType,
    openDeleteInvTypeFlow,
}: Pick<InvTypeActions, "handleEditInvType" | "openDeleteInvTypeFlow"> & {
    T: Translator;
    investmentTypes: readonly InvestmentType[];
