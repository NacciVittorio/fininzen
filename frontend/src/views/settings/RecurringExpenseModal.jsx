      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
        ...
        <div>
          ...
          <CategorySelect
            ...
            onChange={(value) =>
              setRecurringForm((state) => ({ ...state, category: value }))
            }
            ...
            setRecurringForm((state) => ({
              ...
              month_of_year:
                event.target.value === "YEARLY"
                  ? state.month_of_year || String(new Date().getMonth() + 1)
                  : "",
            }))
          }
        >
...
export function DateRangeFields({ T, form, setForm, startField, endField }) {
  return (
    <>
      <div>
        ...
        <input
          ...
          onChange={(event) =>
            setForm((state) => ({ ...state, [startField]: event.target.value }))
          }
        />
      </div>
      <div>
        ...
        <input
          ...
          value={form[endField]}
          onChange={(event) =>
            setForm((state) => ({ ...state, [endField]: event.target.value }))
          }
        />
      </div>
    </>
