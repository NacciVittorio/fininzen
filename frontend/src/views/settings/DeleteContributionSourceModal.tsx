...
import type { DeleteContributionSourceFlow } from "./useContributionSourceManagement";
...
export function DeleteContributionSourceModal({
    ...
    T: Translator;
    deleteContributionSourceFlow: DeleteContributionSourceFlow | null;
    setDeleteContributionSourceFlow: Dispatch<
        SetStateAction<DeleteContributionSourceFlow | null>
    >;
    contributionSources: readonly ContributionSource[];
    confirmDeleteContributionSource: () => void;
}) {
    return (
        <>
            {deleteContributionSourceFlow && (
                ...
                >
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                {deleteContributionSourceFlow.source
                                    .transaction_count || 0}{" "}
                                {T("transactions")}
                            </div>
                        </div>
