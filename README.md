...
| Docker full-stack | PostgreSQL + Redis | Container applicativi dietro un reverse proxy esterno | Percorso di deploy containerizzato; vedi [wiki/DOCKER_DEPLOY.md](wiki/DOCKER_DEPLOY.md). |
