"""
finnet/views.py — Auth views: registration, JWT token, data-sharing grants.
"""
...
from finnet.jwt_cookies import (
    REFRESH_COOKIE_NAME,
    CsrfError,
    clear_auth_cookies,
    set_auth_cookies,
...
from finnet.demo_seed import (
    DEMO_EMAIL,
    DEMO_SEED_VERSION,
    demo_month_key,
    ensure_demo_seed,
)
from finnet.permissions import DEMO_USERNAME, IsNotDemoUser
from finnet.throttles import GrantRateThrottle, LoginRateThrottle, RegisterRateThrottle
from finnet.mixins import require_personal_context
...
class AccountView(APIView):
    ...
    def delete(self, request):
        from finnet.mixins import resolve_view_as
